<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="java.util.List, com.lti.bean.College, com.lti.service.CollegeService, com.lti.service.CollegeServiceImp"%>
...
<h1>List of all accounts</h1>
	...
	<% 	List<College> comlist = (List<College>)application.getAttribute("colmlist");
					for(College o:comlist){
